...
const collections = [
  { id: 1, name: "The Summer Breeze Collection", description: "Lightweight, vibrant, and ready for your summer adventures.", image: "/bags/bag-1.jpg" },
  { id: 2, name: "Midnight Elegance", description: "Sophisticated dark tones and metallic accents for your evening galas.", image: "/bags/bag-4.jpg" },
  { id: 3, name: "Everyday Classics", description: "Timeless designs that never go out of style, perfect for daily use.", image: "/bags/bag-7.jpg" },
];
          ...
          {collections.map((collection, index) => (
            ...
            >
              ...
              <div className="w-full md:w-1/2 text-center md:text-left">
                ...
                <Link href="/shop" className="inline-block border-b-2 border-accent-gold text-text-primary hover:text-accent-gold pb-2 font-medium tracking-widest uppercase transition-colors duration-300 text-sm">
                  Explore Collection
                </Link>
              </div>
            </motion.div>
