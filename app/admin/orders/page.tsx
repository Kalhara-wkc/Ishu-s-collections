...
const orders = [
  { id: "#ORD-001", customer: "Sophia L.", date: "Today, 10:23 AM", total: "LKR 1,450.00", status: "Processing", items: 1 },
  { id: "#ORD-002", customer: "Emily R.", date: "Yesterday, 3:45 PM", total: "LKR 890.00", status: "Shipped", items: 1 },
  { id: "#ORD-003", customer: "Michael K.", date: "Aug 17, 2026", total: "LKR 2,350.00", status: "Delivered", items: 2 },
  { id: "#ORD-004", customer: "Isabella M.", date: "Aug 15, 2026", total: "LKR 1,250.00", status: "Delivered", items: 1 },
  { id: "#ORD-005", customer: "James W.", date: "Aug 14, 2026", total: "LKR 3,650.00", status: "Cancelled", items: 3 },
];
