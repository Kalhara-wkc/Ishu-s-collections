...
export default function Footer() {
  return (
    <footer className="bg-[#4A0E4E] text-[#E5D3B3] pt-24 pb-12 rounded-t-[3rem] mt-0">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-16 mb-20">
          <div className="col-span-1 md:col-span-2">
            ...
            <div className="flex gap-6">
              <a href="#" className="w-12 h-12 rounded-full border border-[#E5D3B3]/30 flex items-center justify-center hover:bg-[#D4AF37] hover:border-[#D4AF37] hover:text-[#4A0E4E] transition-all duration-300">
          ...
          <div>
            ...
            <ul className="space-y-5 text-[#E5D3B3]/70 font-light">
              ...
              <li><Link href="#" className="hover:text-white hover:translate-x-1 transition-all inline-block">Track Order</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="flex border-b border-[#E5D3B3]/30 pb-3 focus-within:border-[#D4AF37] transition-colors">
              <input 
              ...
              />
              <button suppressHydrationWarning className="text-[#D4AF37] hover:text-white font-medium uppercase tracking-wider text-xs transition-colors">Subscribe</button>
            </div>
          </div>
        </div>
